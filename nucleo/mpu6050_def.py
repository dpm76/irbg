...
def dumpDmpMemory(filepath):

    dumpArray(filepath, DMP_MEMORY)
    
    
def dumpDmpConfig(filepath):

    dumpArray(filepath, DMP_CONFIG)
    
    
def dumpDmpUpdates(filepath):

    dumpArray(filepath, DMP_UPDATES)
